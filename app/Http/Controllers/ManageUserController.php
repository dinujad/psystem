    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $user_data = $request->only(['surname', 'first_name', 'last_name', 'email', 'selected_contacts', 'marital_status',
                'blood_group', 'contact_number', 'whatsapp_number', 'fb_link', 'twitter_link', 'social_media_1',
            ...
            if (! empty($user_data['whatsapp_number'])) {
                $user_data['whatsapp_number'] = \App\Services\ProductionNotifier::normalizePhone($user_data['whatsapp_number']);
            }
