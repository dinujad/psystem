...
class LoginController extends Controller
{
    ...
    */
    ...
    /**
     * Allow login using either username or email in same field.
     *
    ...
    {
        $login_input = trim((string) $request->input($this->username()));
    ...
    protected function redirectTo()
    {
        ...
        if (\App\ProductionStageEmployee::isSectionOnlyUser($user)) {
            $sectionUrl = \App\ProductionStageEmployee::dashboardUrl($user->id);
            if ($sectionUrl) {
                return $sectionUrl;
            }
        }
