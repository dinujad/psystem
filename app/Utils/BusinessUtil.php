...
class BusinessUtil extends Util
{
    ...
    {
        return ['url' => '', 'send_to_param_name' => 'to', 'msg_param_name' => 'text', 'request_method' => 'post', 'param_1' => '', 'param_val_1' => '', 'param_2' => '', 'param_val_2' => '', 'param_3' => '', 'param_val_3' => '', 'param_4' => '', 'param_val_4' => '', 'param_5' => '', 'param_val_5' => '', 'data_parameter_type' => 'form-data', 'admin_whatsapp_number' => '', 'hostgrap_wa_email' => env('HOSTGRAP_WHATSAPP_EMAIL', ''), 'hostgrap_wa_api_key' => env('HOSTGRAP_WHATSAPP_API_KEY', ''), 'hostgrap_wa_base_url' => env('HOSTGRAP_WHATSAPP_URL', 'https://wa-api.hostgrap.com')];
    }
