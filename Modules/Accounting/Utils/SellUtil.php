            ...
            ->addColumn(
                ...
                function ($row) use ($only_shipments, $is_admin, $sale_type) {
                    ...
                    if ($row->type == 'sell') {
                        ...
                        $html .= '<li><a href="#" data-href="' . action([\App\Http\Controllers\SellController::class, 'viewMedia'], ["model_id" => $row->id, "model_type" => "Modules\Accounting\Entities\Transaction", 'model_media_type' => 'shipping_document']) . '" class="btn-modal" data-container=".view_modal"><i class="fas fa-paperclip" aria-hidden="true"></i>' . __("lang_v1.shipping_documents") . '</a></li>';
                    }
