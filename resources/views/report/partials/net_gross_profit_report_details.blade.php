...
<p class="text-muted" style="font-size:12px;margin-top:8px;">
    Includes production cost deduction of
    <strong><span class="display_currency" data-currency_symbol="true">{{ $data['total_production_cost'] }}</span></strong>
    for completed print jobs (materials + section labor).
</p>
@endif
