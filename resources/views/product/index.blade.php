...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        // Open product view modal when linked from production (e.g. ?view_product=2)
        (function () {
            var params = new URLSearchParams(window.location.search);
            var viewId = params.get('view_product');
            if (!viewId) return;

            $.ajax({
                url: '{{ url('products/view') }}/' + viewId,
                dataType: 'html',
                success: function (result) {
            ...
            if (window.history.replaceState) {
                ...
                clean.searchParams.delete('view_product');
