...
<div class="form-group col-md-3">
    ...
    {!! Form::text('whatsapp_number', !empty($user->whatsapp_number) ? $user->whatsapp_number : null, ['class' => 'form-control', 'placeholder' => '947XXXXXXXX']); !!}
    <p class="help-block" style="margin:4px 0 0;font-size:11px;color:#6b7280;">Used for weekly task assignment alerts.</p>
</div>
<div class="form-group col-md-3">
