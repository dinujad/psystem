        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              ...
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'whatsapp.assign', false, ['class' => 'input-icheck']); !!}
                  Assign to Agent
                </label>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'production.access', false, ['class' => 'input-icheck']); !!}
              ...
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'production.manager', false, ['class' => 'input-icheck']); !!}
