        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'whatsapp.access', in_array('whatsapp.access', $role_permissions), ['class' => 'input-icheck']); !!}
              ...
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'whatsapp.agent', in_array('whatsapp.agent', $role_permissions), ['class' => 'input-icheck']); !!}
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'production.access', in_array('production.access', $role_permissions), ['class' => 'input-icheck']); !!}
                  Full Production &amp; Inventory Access
                </label>
...
$(function () {
    ...
    $('form input.input-icheck').each(function () {
        var $el = $(this);
        if ($el.data('iCheck')) {
