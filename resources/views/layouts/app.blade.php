...
<body
    class="tw-font-sans tw-antialiased tw-text-gray-900 tw-bg-gray-100 @if (!$pos_layout) theme-admin-pro @endif @if ($pos_layout) hold-transition lockscreen @else hold-transition skin-@if (!empty(session('business.theme_color'))){{ session('business.theme_color') }}@else{{ 'blue-light' }} @endif sidebar-mini @endif" >
