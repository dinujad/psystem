...
// Fix action dropdown clipped by DataTables overflow:hidden styling.
(function () {
    function positionFloatingDropdown($group) {
        ...
        $group.data('floatingMenu', $menu);
        $('body').append($menu);
        $menu.addClass('table-floating-dropdown');
    ...
    // Target any btn-group inside any table row (covers all tables site-wide)
    $(document).on('show.bs.dropdown', 'td .btn-group, th .btn-group', function () {
        positionFloatingDropdown($(this));
    });

    $(document).on('hide.bs.dropdown', 'td .btn-group, th .btn-group', function () {
        var $group = $(this);
        var $menu = $group.data('floatingMenu');
        if ($menu && $menu.length) {
            $menu.removeClass('table-floating-dropdown');
